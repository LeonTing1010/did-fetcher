...
func (_Token *TokenCaller) GRACEPERIOD(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "GRACE_PERIOD")
...
//
// Solidity: function GRACE_PERIOD() view returns(uint256)
func (_Token *TokenSession) GRACEPERIOD() (*big.Int, error) {
	return _Token.Contract.GRACEPERIOD(&_Token.CallOpts)
}

// GRACEPERIOD is a free data retrieval call binding the contract method 0xc1a287e2.
//
// Solidity: function GRACE_PERIOD() view returns(uint256)
func (_Token *TokenCallerSession) GRACEPERIOD() (*big.Int, error) {
	return _Token.Contract.GRACEPERIOD(&_Token.CallOpts)
}
...
func (_Token *TokenCaller) MANAGERROLE(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "MANAGER_ROLE")
...
//
// Solidity: function MANAGER_ROLE() view returns(bytes32)
func (_Token *TokenSession) MANAGERROLE() ([32]byte, error) {
	return _Token.Contract.MANAGERROLE(&_Token.CallOpts)
}

// MANAGERROLE is a free data retrieval call binding the contract method 0xec87621c.
//
// Solidity: function MANAGER_ROLE() view returns(bytes32)
func (_Token *TokenCallerSession) MANAGERROLE() ([32]byte, error) {
	return _Token.Contract.MANAGERROLE(&_Token.CallOpts)
}
...
// GetExpires is a free data retrieval call binding the contract method 0x3dca885d.
//
// Solidity: function getExpires(uint256 tokenId) view returns(uint256)
func (_Token *TokenCaller) GetExpires(opts *bind.CallOpts, tokenId *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "getExpires", tokenId)
...
//
// Solidity: function getExpires(uint256 tokenId) view returns(uint256)
func (_Token *TokenSession) GetExpires(tokenId *big.Int) (*big.Int, error) {
	return _Token.Contract.GetExpires(&_Token.CallOpts, tokenId)
}

// GetExpires is a free data retrieval call binding the contract method 0x3dca885d.
//
// Solidity: function getExpires(uint256 tokenId) view returns(uint256)
func (_Token *TokenCallerSession) GetExpires(tokenId *big.Int) (*big.Int, error) {
	return _Token.Contract.GetExpires(&_Token.CallOpts, tokenId)
}

// GetExpiresUuid is a free data retrieval call binding the contract method 0x40920986.
//
// Solidity: function getExpiresUuid(address uuid) view returns(uint256)
func (_Token *TokenCaller) GetExpiresUuid(opts *bind.CallOpts, uuid common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "getExpiresUuid", uuid)
...
//
// Solidity: function getExpiresUuid(address uuid) view returns(uint256)
func (_Token *TokenSession) GetExpiresUuid(uuid common.Address) (*big.Int, error) {
	return _Token.Contract.GetExpiresUuid(&_Token.CallOpts, uuid)
}

// GetExpiresUuid is a free data retrieval call binding the contract method 0x40920986.
//
// Solidity: function getExpiresUuid(address uuid) view returns(uint256)
func (_Token *TokenCallerSession) GetExpiresUuid(uuid common.Address) (*big.Int, error) {
	return _Token.Contract.GetExpiresUuid(&_Token.CallOpts, uuid)
}
...
//
// Solidity: function initialize(address owner, address manager) returns()
func (_Token *TokenTransactor) Initialize(opts *bind.TransactOpts, owner common.Address, manager common.Address) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "initialize", owner, manager)
}

// Initialize is a paid mutator transaction binding the contract method 0x485cc955.
//
// Solidity: function initialize(address owner, address manager) returns()
func (_Token *TokenSession) Initialize(owner common.Address, manager common.Address) (*types.Transaction, error) {
	return _Token.Contract.Initialize(&_Token.TransactOpts, owner, manager)
}

// Initialize is a paid mutator transaction binding the contract method 0x485cc955.
//
// Solidity: function initialize(address owner, address manager) returns()
func (_Token *TokenTransactorSession) Initialize(owner common.Address, manager common.Address) (*types.Transaction, error) {
	return _Token.Contract.Initialize(&_Token.TransactOpts, owner, manager)
}

// Mint is a paid mutator transaction binding the contract method 0xc6c3bbe6.
//
// Solidity: function mint(address to, address uuid, uint256 expireAt) returns()
func (_Token *TokenTransactor) Mint(opts *bind.TransactOpts, to common.Address, uuid common.Address, expireAt *big.Int) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "mint", to, uuid, expireAt)
}

// Mint is a paid mutator transaction binding the contract method 0xc6c3bbe6.
//
// Solidity: function mint(address to, address uuid, uint256 expireAt) returns()
func (_Token *TokenSession) Mint(to common.Address, uuid common.Address, expireAt *big.Int) (*types.Transaction, error) {
	return _Token.Contract.Mint(&_Token.TransactOpts, to, uuid, expireAt)
}

// Mint is a paid mutator transaction binding the contract method 0xc6c3bbe6.
//
// Solidity: function mint(address to, address uuid, uint256 expireAt) returns()
func (_Token *TokenTransactorSession) Mint(to common.Address, uuid common.Address, expireAt *big.Int) (*types.Transaction, error) {
	return _Token.Contract.Mint(&_Token.TransactOpts, to, uuid, expireAt)
}

// Recycle is a paid mutator transaction binding the contract method 0xbaca0004.
//
// Solidity: function recycle(address uuid) returns()
func (_Token *TokenTransactor) Recycle(opts *bind.TransactOpts, uuid common.Address) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "recycle", uuid)
}

// Recycle is a paid mutator transaction binding the contract method 0xbaca0004.
//
// Solidity: function recycle(address uuid) returns()
func (_Token *TokenSession) Recycle(uuid common.Address) (*types.Transaction, error) {
	return _Token.Contract.Recycle(&_Token.TransactOpts, uuid)
}

// Recycle is a paid mutator transaction binding the contract method 0xbaca0004.
//
// Solidity: function recycle(address uuid) returns()
func (_Token *TokenTransactorSession) Recycle(uuid common.Address) (*types.Transaction, error) {
	return _Token.Contract.Recycle(&_Token.TransactOpts, uuid)
}
...
func (_Token *TokenTransactor) SetBaseUrl(opts *bind.TransactOpts, _baseURL string) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "setBaseUrl", _baseURL)
}

// SetBaseUrl is a paid mutator transaction binding the contract method 0xc7c3268b.
//
// Solidity: function setBaseUrl(string _baseURL) returns()
func (_Token *TokenSession) SetBaseUrl(_baseURL string) (*types.Transaction, error) {
	return _Token.Contract.SetBaseUrl(&_Token.TransactOpts, _baseURL)
}

// SetBaseUrl is a paid mutator transaction binding the contract method 0xc7c3268b.
//
// Solidity: function setBaseUrl(string _baseURL) returns()
func (_Token *TokenTransactorSession) SetBaseUrl(_baseURL string) (*types.Transaction, error) {
	return _Token.Contract.SetBaseUrl(&_Token.TransactOpts, _baseURL)
}
...
// TokenUserRecycleIterator is returned from FilterUserRecycle and is used to iterate over the raw logs and unpacked data for UserRecycle events raised by the Token contract.
type TokenUserRecycleIterator struct {
	Event *TokenUserRecycle // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TokenUserRecycleIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TokenUserRecycleIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TokenUserRecycleIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TokenUserRecycle represents a UserRecycle event raised by the Token contract.
type TokenUserRecycle struct {
	Uuid common.Address
	Raw  types.Log // Blockchain specific contextual infos
}

// FilterUserRecycle is a free log retrieval operation binding the contract event 0xa3d7775bd5f9cdedbb729ccb32f865235da08da2a0fba8eade799a56b4463aca.
//
// Solidity: event UserRecycle(address indexed uuid)
func (_Token *TokenFilterer) FilterUserRecycle(opts *bind.FilterOpts, uuid []common.Address) (*TokenUserRecycleIterator, error) {
	...
	logs, sub, err := _Token.contract.FilterLogs(opts, "UserRecycle", uuidRule)
	if err != nil {
		return nil, err
	}
	return &TokenUserRecycleIterator{contract: _Token.contract, event: "UserRecycle", logs: logs, sub: sub}, nil
}

// WatchUserRecycle is a free log subscription operation binding the contract event 0xa3d7775bd5f9cdedbb729ccb32f865235da08da2a0fba8eade799a56b4463aca.
//
// Solidity: event UserRecycle(address indexed uuid)
func (_Token *TokenFilterer) WatchUserRecycle(opts *bind.WatchOpts, sink chan<- *TokenUserRecycle, uuid []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Token.contract.WatchLogs(opts, "UserRecycle", uuidRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TokenUserRecycle)
				if err := _Token.contract.UnpackLog(event, "UserRecycle", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseUserRecycle is a log parse operation binding the contract event 0xa3d7775bd5f9cdedbb729ccb32f865235da08da2a0fba8eade799a56b4463aca.
//
// Solidity: event UserRecycle(address indexed uuid)
func (_Token *TokenFilterer) ParseUserRecycle(log types.Log) (*TokenUserRecycle, error) {
	event := new(TokenUserRecycle)
	if err := _Token.contract.UnpackLog(event, "UserRecycle", log); err != nil {
		return nil, err
	}
